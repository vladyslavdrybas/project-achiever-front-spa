...
const _pool: Record<string, string> = {
  ...
  achievementListOwnedCollection: '/achievement/list/[user]/own/[timestamp]/[offset]/[limit]/[variant]',
  postsCollection: '/post/[user]/[timestamp]/[offset]/[limit]/[variant]',
  listAchievementCollection: '/list/[list]/[timestamp]/[offset]/[limit]/[variant]',
  listView: '/list/[list]',
  userProfile: '/user/[userId]',
  userInfoView: '/user/[userId]/info',

  achievementListSharedCollection: '/achievement/list/[user]/share/[timestamp]/[offset]/[limit]/[variant]',
